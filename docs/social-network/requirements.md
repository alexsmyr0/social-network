> Source: Zone01 social-network assignment pasted by the project owner on 2026-09-17. Wording preserved; only Markdown formatting added. This is the social-network requirements authority. Implementation notes and unresolved interpretations belong in [planning.md](planning.md). The separate Zone01 audit checklist has not been supplied.
