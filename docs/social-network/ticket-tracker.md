...
17 tickets: 8 in A, 9 in B. Done: 7. In progress: 0. Blocked: 0. Not started: 10. Ready to start: SN-B04, SN-A04, SN-A05 and SN-A08.
...
| [x] | [SN-B03](track-b.md#sn-b03--startup-migrations-and-account-schema) | Startup migrations and account schema | SN-B08 | SN-B04 | [Startup and recovery notes](backend-migrations.md). On `77c0ebd`, `make test` **exit 0**: build, Biome, gofmt, vet, Go/integration/race suites, Vitest 488/488, Playwright 5/5 with a disposable DB. SQLite tests cover first/repeated startup, dirty migration refusal, legacy relationship preservation on rejection, account constraints and independent session rows. |
