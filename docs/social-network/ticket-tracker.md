...
| [x] | [SN-A04](track-a.md#sn-a04--registration-ui) | Registration UI | SN-A03, SN-B02 | SN-A06 | Frontend-only contract fixtures: `bun run test:a04` 11/11; `make test` exit 0 with Vitest 499/499 and Playwright 7/7. Required/optional payloads, JPEG/PNG/GIF preview/removal, validation, duplicate email, network/upload recovery, duplicate-submit prevention, keyboard and 360px/desktop checks pass. Real backend/media integration remains SN-A07. |
